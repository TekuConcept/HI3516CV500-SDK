...
#undef EINVAL
#endif
#define EINVAL (22) // 0x16
#define EINVAL_AND_RESET (22 | 0X80) // 0x96 (150)
/* invalid parameter range */
#ifdef ERANGE
#undef ERANGE  /* to avoid redefinition */
#endif
#define ERANGE (34) // 0x22
#define ERANGE_AND_RESET  (34 | 0X80) // 0xA2 (162)

#ifdef EOVERLAP_AND_RESET
#undef EOVERLAP_AND_RESET
#endif
/*Once the buffer overlap is detected, the dest buffer must be reseted! */
#define EOVERLAP_AND_RESET (54 | 0X80) // 0xB6 (182)
