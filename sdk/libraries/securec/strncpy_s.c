 ...
 */
static errno_t
CheckSrcCountRange(char *strDest, size_t destMax, const char *strSrc, size_t count)
{
 ...
 */
errno_t
strncpy_error(char *strDest, size_t destMax, const char *strSrc, size_t count)
{
 ...
 */
errno_t
strncpy_s(char *strDest, size_t destMax, const char *strSrc, size_t count)
{
