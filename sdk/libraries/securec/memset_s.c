 ...
 */
static errno_t
SecMemsetError(void *dest, size_t destMax, int c, size_t count)
{
 ...
 */
static void
SecDoMemsetOpt(void *dest, int c, size_t count)
{
 ...
 */
errno_t
memset_sOptAsm(void *dest, size_t destMax, int c, size_t count)
{
    if (SECUREC_MEMSET_PARAM_OK(dest, destMax, count)) {
        SecDoMemsetOpt(dest, c, count);
        return EOK;
 ...
 */
errno_t
memset_sOptTc(void *dest, size_t destMax, int c, size_t count)
{
