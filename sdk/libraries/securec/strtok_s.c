 ...
 */
static char *
SecFindBegin(char *strToken, const char *strDelimit)
{
    char *token = strToken;
    while (*token != '\0') {
 ...
 */
static char *
SecFindRest(char *strToken, const char *strDelimit)
{
 ...
 */
static char *
SecUpdateToken(char *strToken, const char *strDelimit, char **context)
{
