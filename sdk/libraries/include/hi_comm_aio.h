...
typedef struct hiAI_RECORDVQE_CONFIG_S { // sizeof=0x8C
    HI_U32              u32OpenMask;
...
typedef struct hiAI_TALKVQE_CONFIG_S { // sizeof=0x80
    HI_U32              u32OpenMask;
...
typedef struct hiAO_VQE_CONFIG_S { // sizeof=0x4C
    HI_U32              u32OpenMask;
...
typedef struct hiVQE_MODULE_CONFIG_S { // sizeof=0x4
    HI_VOID *pHandle;
} VQE_MODULE_CONFIG_S;

typedef struct hiAUDIO_VQE_REGISTER_S { // sizeof=0x30
...
typedef struct hiAUDIO_SAVE_FILE_INFO_S { // sizeof=0x208
    HI_BOOL     bCfg;
...
typedef struct hiAUDIO_FILE_STATUS_S { // sizeof=0x4
    HI_BOOL     bSaving;
} AUDIO_FILE_STATUS_S;
...
typedef struct hiAUDIO_MOD_PARAM_S { // sizeof=0x4
